...
function Precache(context)
	...
	PrecacheResource("soundfile", "soundevents/kingdom_global_soundevents.vsndevts", context)
	...
	PrecacheResource("soundfile", "soundevents/voscripts/game_sounds_vo_skeletonking.vsndevts", context)
	...
	PrecacheResource("soundfile", "soundevents/voscripts/game_sounds_vo_doombringer.vsndevts", context)
