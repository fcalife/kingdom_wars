...
function GameMode:_InitGameMode()
	...
	PLAYER_COLOR_LIST = {}
	PLAYER_COLOR_LIST[1] = Vector(32, 32, 144)		-- #202090
	PLAYER_COLOR_LIST[2] = Vector(144, 32, 32)		-- #902020
	PLAYER_COLOR_LIST[3] = Vector(197, 78, 168)		-- #c54da8
	PLAYER_COLOR_LIST[4] = Vector(255, 108, 0)		-- #FF6C00
	PLAYER_COLOR_LIST[5] = Vector(52, 85, 255)		-- #3455FF
	PLAYER_COLOR_LIST[6] = Vector(101, 212, 19)		-- #65d413
	PLAYER_COLOR_LIST[7] = Vector(129, 83, 54)		-- #815336
	PLAYER_COLOR_LIST[8] = Vector(27, 208, 232)		-- #1bc0d8

	SetTeamCustomHealthbarColor(DOTA_TEAM_GOODGUYS, PLAYER_COLOR_LIST[1].x, PLAYER_COLOR_LIST[1].y, PLAYER_COLOR_LIST[1].z)
	SetTeamCustomHealthbarColor(DOTA_TEAM_BADGUYS, PLAYER_COLOR_LIST[2].x, PLAYER_COLOR_LIST[2].y, PLAYER_COLOR_LIST[2].z)
	SetTeamCustomHealthbarColor(DOTA_TEAM_CUSTOM_1, PLAYER_COLOR_LIST[3].x, PLAYER_COLOR_LIST[3].y, PLAYER_COLOR_LIST[3].z)
	SetTeamCustomHealthbarColor(DOTA_TEAM_CUSTOM_2, PLAYER_COLOR_LIST[4].x, PLAYER_COLOR_LIST[4].y, PLAYER_COLOR_LIST[4].z)
	SetTeamCustomHealthbarColor(DOTA_TEAM_CUSTOM_3, PLAYER_COLOR_LIST[5].x, PLAYER_COLOR_LIST[5].y, PLAYER_COLOR_LIST[5].z)
	SetTeamCustomHealthbarColor(DOTA_TEAM_CUSTOM_4, PLAYER_COLOR_LIST[6].x, PLAYER_COLOR_LIST[6].y, PLAYER_COLOR_LIST[6].z)
	SetTeamCustomHealthbarColor(DOTA_TEAM_CUSTOM_5, PLAYER_COLOR_LIST[7].x, PLAYER_COLOR_LIST[7].y, PLAYER_COLOR_LIST[7].z)
	SetTeamCustomHealthbarColor(DOTA_TEAM_CUSTOM_6, PLAYER_COLOR_LIST[8].x, PLAYER_COLOR_LIST[8].y, PLAYER_COLOR_LIST[8].z)
